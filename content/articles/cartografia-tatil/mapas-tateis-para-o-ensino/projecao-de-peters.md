Title: Projeção de Peters
Section: cartografia-tatil
save_as: cartografia-tatil/mapas-tateis-para-o-ensino/projecao-de-peters.html
    ...
    set maps = {
        'Projeção de Peters': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['projecao-de-peters-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['projecao-de-peters-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['projecao-de-peters-microcapsulado.jpg',
                             'projecao-de-peters-microcapsulado-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
