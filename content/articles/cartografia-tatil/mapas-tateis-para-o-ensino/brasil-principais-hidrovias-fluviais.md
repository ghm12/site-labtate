    ...
    set maps = {
        'Principais Hidrovias Fluviais do Brasil': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['brasil-principais-hidrovias-fluviais-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['brasil-principais-hidrovias-fluviais-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['brasil-principais-hidrovias-fluviais-microcapsulado.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
