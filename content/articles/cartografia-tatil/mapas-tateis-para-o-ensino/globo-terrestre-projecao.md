Title: Projeção do Globo Terrestre
Section: cartografia-tatil
save_as: cartografia-tatil/mapas-tateis-para-o-ensino/globo-terrestre-projecao.html
    ...
    set maps = {
        'Projeção do Globo Terrestre': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['globo-terrestre-projecao-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['globo-terrestre-projecao-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['globo-terrestre-projecao-microcapsulado.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
