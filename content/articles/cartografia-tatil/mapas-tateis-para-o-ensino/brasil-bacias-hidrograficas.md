    ...
    set maps = {
        'Bacias Hidrográficas do Brasil': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['brasil-bacias-hidrograficas-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['brasil-bacias-hidrograficas-baixa-visao.jpg',
                             'brasil-bacias-hidrograficas-baixa-visao-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['brasil-bacias-hidrograficas-microcapsulado.jpg',
                             'brasil-bacias-hidrograficas-microcapsulado-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
