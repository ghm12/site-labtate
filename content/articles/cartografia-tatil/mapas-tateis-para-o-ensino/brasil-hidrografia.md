    ...
    set maps = {
        'Hidrografia do Brasil': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['brasil-hidrografia-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['brasil-hidrografia-baixa-visao.jpg',
                             'brasil-hidrografia-baixa-visao-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['brasil-hidrografia-microcapsulado.jpg',
                             'brasil-hidrografia-microcapsulado-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
