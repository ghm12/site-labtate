Title: Planta Baixa de Ruas
Section: cartografia-tatil
save_as: cartografia-tatil/mapas-tateis-para-o-ensino/planta-baixa-ruas.html
...
{%
    set maps = {
        'Planta Baixa de Ruas': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['planta-ruas-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['planta-ruas-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['planta-ruas-microcapsulado.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
