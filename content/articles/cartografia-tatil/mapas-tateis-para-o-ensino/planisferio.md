...
save_as: cartografia-tatil/mapas-tateis-para-o-ensino/planisferio.html
    ...
    set maps = {
        'Planisfério': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['planisferio-tatil.jpg',
                             'planisferio-tatil-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['planisferio-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['planisferio-microcapsulado.jpg',
                             'planisferio-microcapsulado-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
