    ...
    set maps = {
        'População do Brasil': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['brasil-populacao-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['brasil-populacao-baixa-visao.jpg',
                             'brasil-populacao-baixa-visao-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['brasil-populacao-microcapsulado.jpg',
                             'brasil-populacao-microcapsulado-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
