Title: Planta Baixa da Casa
Section: cartografia-tatil
save_as: cartografia-tatil/mapas-tateis-para-o-ensino/planta-baixa-casa.html
    ...
    set maps = {
        'Planta Baixa da Casa': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['planta-casa-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['planta-casa-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['planta-casa-microcapsulado.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
