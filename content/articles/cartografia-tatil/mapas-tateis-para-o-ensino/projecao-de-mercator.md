...
save_as: cartografia-tatil/mapas-tateis-para-o-ensino/projecao-de-mercator.html
    ...
    set maps = {
        'Projeção de Mercator': {
            '': [
                {
                    'title': 'Mapa Tátil',
                    'imgs': ['projecao-de-mercator-tatil.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa de Baixa Visão',
                    'imgs': ['projecao-de-mercator-baixa-visao.jpg'],
                    'size': '33,5x50,5cm',
                },
                {
                    'title': 'Mapa Microcapsulado',
                    'imgs': ['projecao-de-mercator-microcapsulado.jpg',
                             'projecao-de-mercator-microcapsulado-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
