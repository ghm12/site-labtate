Title: Terminal Rita Maria
Section: cartografia-tatil
save_as: cartografia-tatil/mapas-tateis-para-mobilidade/florianopolis-rita-maria.html
    ...
    set maps = {
        'Terminal Rita Maria': {
            '': [
                {
                    'title': '',
                    'imgs': ['florianopolis-rita-maria.jpg',
                             'florianopolis-rita-maria-legenda.jpg'],
                    'size': '33,5x50,5cm',
                },
            ]
        }
